...
texte = ['Dans la partie latérale gauche, vous pouvez définir différents paramètres pour vos simulations :\n',
	 ...
	 ' - **Taux d’inflation :** à ajuster selon les données mises à jour chaque année par l\'INSEE ([ici](https://www.insee.fr/fr/statistiques/5895592#:~:text=Sur%20un%20an%2C%20selon%20l,une%20moindre%20mesure%20%E2%80%93%20des%20services.) pour 2021). Nous prenons par défaut la valeur moyenne sur les dernières années\n',]
texte = ' '.join(texte)
...
taux_inflation = 0.01 * st.sidebar.slider('Taux d\'inflation', 0., 20., inflation_moyenne, 0.1, format="%f%%")
